...
main (int argc, char *argv[])
{
	...
	GDataDocumentsSpreadsheet *documents_spreadsheet = GDATA_DOCUMENTS_SPREADSHEET( gdata_documents_spreadsheet_new_from_xml (xml_spreadsheet, strlen(xml_spreadsheet), error_spreadsheet));
	...
	GDataDocumentsPresentation *documents_presentation = GDATA_DOCUMENTS_PRESENTATION ( gdata_documents_presentation_new_from_xml (xml_presentation, strlen (xml_presentation), error_presentation));
